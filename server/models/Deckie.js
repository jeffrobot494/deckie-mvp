...
class Deckie {
  static async create({ deckieUrl, gameName, theme, imageUrls }) {
    const query = `
      INSERT INTO deckies (deckie_url, game_name, theme, image_urls)
      VALUES ($1, $2, $3, $4)
      RETURNING *
    `;
    
    const values = [deckieUrl, gameName, theme, imageUrls];
